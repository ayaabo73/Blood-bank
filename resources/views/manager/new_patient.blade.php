...
<body>
    ...
    <div class="ALL">
        ...
        <form action="{{route('storep')}}" method="post" enctype="multipart/form-data">
                @csrf
  ...
  <input type="email"  name="email"/>&ensp;&ensp;&ensp;
  ...
  <form action="{{route('patients')}}" method=get style=" padding-right: 100px;margin-top:-46px;margin-right: 15px; font-size: 29px;text-decoration:right;text-align: right;font-family: cursive;">

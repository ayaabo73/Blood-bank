...
<body>
    ...
    <div class="ALL">
        ...
        <form action="{{route('updatedonor',$donor->email)}}" method="post">
 ...
 <select  name="blood_type" value="{{$donor->blood_type}}">
  ...
  <input type="hidden" name="points" value="{{$donor->points}}">

  <button type="submit" name="add">حفظ</button> &ensp;&ensp;
  
</form>           
<form action="{{route('donor')}}" method=get style=" padding-right: 100px;margin-top:-46px;margin-right: 15px; font-size: 29px;text-decoration:right;text-align: right;font-family: cursive;">
